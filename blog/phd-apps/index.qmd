...
I am by no means an expert at what biostatistics graduate programs are looking for, and this is not a comprehensive post on applying to (biostatistics) graduate school. For more general information, I recommend [**Lucy Lai**](https://lucy-lai.com/blog/gradapps)'s post on applying to graduate programs. Other excellent posts with detailed information about the biostatistics application process include those by [**Simon Couch**](https://www.simonpcouch.com/blog/apply-to-stats-grad-school) and [**Daniel Posmik**](https://posmikdc.github.io/blog/2024/biostats-phd-admit/). Nonetheless, perhaps some of you might find my experience useful, or you might be able to pass it on to a future applicant who will find it useful!
...
***[Edit August 2024]* Tidbits on funding I learned about funding after beginning my PhD program:**
  ...
  (1) I learned in some cases you can actually negotiate your offer with schools if you have other offers! I have no advice to offer on this, only that I've heard it is possible.

  (2) The [National Science Foundation (NSF) Graduate Student Research Fellowship](https://www.nsfgrfp.org/) is an excellent opportunity for U.S. citizens to secure their own funding prior to beginning a PhD program. If you're returning to school after prior time in graduate school, like I was, you can *only* apply for the scholarship before beginning your PhD program. The deadline is in October. If you'd like to apply, Simon Couch wrote a [blog post](https://www.simonpcouch.com/blog/2021-08-02-apply-to-nsf-grfp/) about his experience. One of my classmates came into UW with this fellowship.
  
  (3) Another opportunity for U.S. students is to apply for a National Institutes of Health F31 Fellowship. This is another way to secure your own funding, and there is no limit on the number of years of prior schooling to apply.
