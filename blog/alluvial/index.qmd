...
> **Alluvial** plots, or **Sankey diagrams**, can be used to show the **movement of individual units across a single variable**, such as time. In this post I'll show the steps to make an alluvial plot for a time-varying exposure and time-to-event outcome.
...
In this post I'll walk through using alluvial plots to show longitudinal data. I've written a post about showing longitudinal data in treatment timelines... but sometimes treatment timelines are too granular, and we need to show multiple longitudinal variables for many units, for example, people.

One way to do this is by using alluvial plots, or sankey diagrams. In an alluvial plot,,... 

 I'll use `ggalluvial` to show the movement of the following complexities over time:
...
...in a cohort of severely ill COVID-19 patients
